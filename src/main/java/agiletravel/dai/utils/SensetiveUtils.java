...
public class SensetiveUtils {
    /**参考DFA算法demo:http://blog.csdn.net/chenssy/article/details/26961957*/

        public static String filePath = "sensetive.txt";//敏感词库文件路径
        public static Set<String> words;
        public static Map<String,String> wordMap;
        public static int minMatchTYpe = 1;      //最小匹配规则
        public static int maxMatchType = 2;      //最大匹配规则
        static{
            SensetiveUtils.words = readTxtByLine(filePath);
            addBadWordToHashMap(SensetiveUtils.words);
        }
...
//            Set<String> s = SensetiveUtils.words;
//            Map<String,String> map = SensetiveUtils.wordMap;
//            System.out.println("敏感词的数量：" + SensetiveUtils.wordMap.size());
//            String string = "我草泥马，操你妈，法轮功大法好。狗日的";
//            System.out.println("待检测语句字数：" + string.length());
//            Set<String> set = SensetiveUtils.getBadWord(string, 2);
